...
class FaceView: UIView {
    ...
    private struct Scaling {
        ...
        static let FaceRadiusToEyeSeparationRation: CGFloat = 2
    ...
    func bezierPathForEye(eye: EYES)->UIBezierPath {
        ...
        switch eye {
        case .Left:
            eyeCenter.x -= eyeHorizontalSeparation
            
        case .Right:
            eyeCenter.x += eyeHorizontalSeparation
        }
        
        let eyeRadio = faceRadius/Scaling.FaceRadiusToEyeRadiusRatio
    ...
    func bezierPathForMouth(smile:Double) -> UIBezierPath {
        let mouthWidth = faceRadius / Scaling.FaceRadiusToMouthWidthRatio
        let mouthHeight = faceRadius / Scaling.FaceRadiusToMouthHeigthRatio
        let mouthVerticalOffset = faceRadius / Scaling.FaceRadiusToMouthOffsetRatio
        
        let smileHeight = CGFloat(max(min(smile, 1), -1)) * mouthHeight
